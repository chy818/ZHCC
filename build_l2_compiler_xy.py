...
# -*- coding: utf-8 -*-
"""
正确的 L2 编译器构建脚本 - 使用 compiler.xy（完整版本）
"""
...
def main():
    print("=" * 40)
    print("  Building L2 Compiler (Complete Version)")
    print("  Using: compiler.xy")
    print("=" * 40)
    print()
    ...
    # Step 1: 只编译 compiler.xy（它 import 了所有其他模块）
    print("[Step 1] Compiling compiler.xy...")
    src_path = os.path.join(SRC_DIR, "compiler.xy")
    ir_path = os.path.join(OUTPUT_DIR, "compiler.ll")
    ...
    if result.returncode != 0:
        print(f"    ERROR: Failed to compile compiler.xy")
    ...
    obj_path = os.path.join(OUTPUT_DIR, "compiler.o")
